...
export const productInput = z.object({
    name: z.string().min(1,"Product name should be at least of 1 characters.").max(30,"Product name should not increaes more than 30 characters."),
...
export const categoryInputUpdate = z.object({
    name: z.string().min(1,"Category name should be at least of 1 characters.").max(30,"Category name should not increaes more than 30 characters.").optional(),
    ...
    product :z.string().min(1,"Product id should not be less than 1 characters.").max(30,"Product id should not be more than 30 characters.").optional()
});

export const cartInput = z.object({
    userId:z.string().min(1,"User id should be atleast 1 word.").max(30,"User id should not be more than 30 words."),
    productId:z.string().min(1,"Product id should be atleast 1 word.").max(30,"Product id should not be more than 30 words."),
    quantity:z.number(),
});